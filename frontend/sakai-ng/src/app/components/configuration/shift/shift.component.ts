...
export class ShiftComponent implements OnInit, OnDestroy {
    ...
    addClick() {
        ...
        this.end_time = null;
        this.tolerance_before_start_time = null;
        this.tolerance_after_start_time = null;
        this.tolerance_before_end_time = null;
        this.tolerance_after_end_time = null;
    ...
    addShift() {
        ...
        const shift = {
            ...
            tolerance_before_start_time: this.tolerance_before_start_time || 0,
            tolerance_after_start_time: this.tolerance_after_start_time || 0,
            tolerance_before_end_time: this.tolerance_before_end_time || 0,
            tolerance_after_end_time: this.tolerance_after_end_time || 0,
    ...
    editClick(item: any) {
        ...
        this.tolerance_before_start_time = item.tolerance_before_start_time;
        this.tolerance_after_start_time = item.tolerance_after_start_time;
        this.tolerance_before_end_time = item.tolerance_before_end_time;
        this.tolerance_after_end_time = item.tolerance_after_end_time;
